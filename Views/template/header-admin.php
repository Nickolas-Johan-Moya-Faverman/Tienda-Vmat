...
<head>
	...
	<!--favicon-->
	<link rel="icon" href="<?php echo BASE_URL; ?>assets/images/logovmat.jpg" type="image/png"/>
	...
	<div class="wrapper">
		...
		<div class="sidebar-wrapper" data-simplebar="true">
			<div class="sidebar-header">
				<div>
					<img src="<?php echo BASE_URL; ?>assets/images/logovmat.jpg" class="logo-icon" alt="logo icon">
				</div>
				<div>
			...
			<ul class="metismenu" id="menu">
				...
				<li>
					<a href="<?php echo BASE_URL . 'usuarios';?>">
						<div class="menu-title"><i class="fa fa-user-lock"></i> Aministradores</div>
					</a>
				</li>
				<li>
					<a href="<?php echo BASE_URL . 'clientien';?>">
						<div class="menu-title"><i class="fas fa-users"></i> Clientes</div>
					</a>
				</li>
				<li>
				...
				<li>
					<a href="<?php echo BASE_URL . 'citas';?>">
						<div class="menu-title"><i class="fas fa-eye"></i> Citas/reservas</div>
					</a>
				</li>
			</ul>
			<!--end navigation-->
				...
				<nav class="navbar navbar-expand">
					...
					<div class="user-box dropdown">
						<a class="d-flex align-items-center nav-link dropdown-toggle dropdown-toggle-nocaret" href="#" role="button" data-bs-toggle="dropdown" aria-expanded="false">
							<img src="<?php echo BASE_URL; ?>assets/images/logovmat.jpg" class="user-img" alt="user avatar">
