...
<div class="container py-5">
                        ...
                        <div class="card shadow-lg">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="<?php echo BASE_URL . 'clientes/salir';?>"><i class="fas fa-times-circle"></i>Cerrar sesion</a></li>
                                </ul>
                            </div>
                            <div class="card-body text-center">
                                <img class="img-thumbnail rounded-circle" src="<?php echo BASE_URL . 'assets/images/clientes/default.png'; ?>" alt="" width="150px">
                                <hr>
    ...
    <?php } else { ?>
        <div class="alert alert-danger text-center" role="alert">
            ...
            <div class="h2">
                NO PUDIMOS ENVIARTE LA VERIFICACION, VERIFICA TU CORREO ELECTRONICO
            </div>
        </div>
    <?php } ?>
</div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-lg-4 pb-5">
                        <div class="h-100 py-5 services-icon-wap shadow" id="estadoCompletado">
                            ...
                            <h2 class="h5 mt-4 text-center">Finalizado</h2>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="table-responsive">
