        ...
        <div class="container pb-5">
            <div class="row">
                <div class="col-lg-5 mt-5">
                    <div class="card mb-3">
                        <img class="card-img img-fluid" src="<?php echo BASE_URL . $data['producto']['imagen'];?>" alt="Card image cap"
                            id="product-detail">
                    </div>
                </div>
                <!-- col end -->
                            ...
                            <form action="" method="GET">
                                ...
                                <div class="row pb-3">
                                    <div class="col d-grid">
                                        <button type="subm it" class="btn btn-util btn-lg">Comprar</button>
                                    </div>
                                    <div class="col d-grid">
                                        <button type="button" class="btn btn-util btn-lg" id="btnAddCart">Añadir al carrito</button>
                                    </div>
                                    <div class="col d-grid">
                                    <button type="subm it" class="btn btn-util btn-lg" id="btn3d">Visualizacion 3D</button>
                                    </div>
                                </div>
                            </form>
                        </div>
                    ...
                    <div class="p-2 pb-3">
                        <div class="product-wap card rounded-0">
                            <div class="card rounded-0">
                                <img class="card-img rounded-0 img-fluid" src="<?php echo BASE_URL . $relacion['imagen'];?>">
                                <div
                                    ...
                                    <ul class="list-unstyled">
                                        ...
                                        <li><a class="btn btn-util text-white mt-2 btnAddcarrito" href="#" prod="<?php echo $relacion['id'];?>"><i
