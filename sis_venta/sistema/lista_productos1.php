...
$query = "SELECT ventas.*, cliente.Correo, cliente.Nombre, cliente.Direccion 
          ...
          WHERE ventas.Estado = 2"; // Obtener pedidos en proceso
...
<div class="container-fluid">
    ...
    <ul class="nav nav-tabs" id="myTab" role="tablist">
        ...
        <li class="nav-item" role="presentation">
            <a class="nav-link active" id="proceso-tab" data-bs-toggle="tab" href="lista_productos1.php" role="tab" aria-controls="listaProceso" aria-selected="false">En proceso</a>
        </li>
        <li class="nav-item" role="presentation">
            <a class="nav-link" id="profile-tab" data-bs-toggle="tab" href="lista_productos2.php" role="tab" aria-controls="pedidosFinalizados" aria-selected="false">Finalizados</a>
        </li>
    </ul>
                                ...
                                <tbody>
                                    ...
                                    if (mysqli_num_rows($result) > 0) {
                                        while ($row = mysqli_fetch_assoc($result)) {
                                            ...
                                            echo "<form action='pep.php' method='post'>";
                                            echo "<input type='hidden' name='id_venta' value='" . $row['ID_Ventas'] . "'>";
                                            echo "<button type='submit' class='btn btn-primary' name='pep'><i class='fas fa-play'></i> Comenzar</button>";
                                            echo "</form>";
                                            echo "</td>";
                                            echo "</tr>";
                                        }
