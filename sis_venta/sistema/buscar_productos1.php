...
$query = "SELECT ventas.*, cliente.Correo, cliente.Nombre, cliente.Direccion 
          ...
          WHERE ventas.Estado = 2"; // Obtener pedidos pendientes
...
<div class="container-fluid">
    ...
    <li class="nav-item" role="presentation">
        <a class="nav-link active" id="home-tab" data-bs-toggle="tab" href="buscar_productos1.php" role="tab" aria-controls="listaProceso" aria-selected="false">En proceso</a>
    </li>
    <li class="nav-item" role="presentation">
        <a class="nav-link" id="home-tab" data-bs-toggle="tab" href="buscar_productos2.php" role="tab" aria-controls="pedidosFinalizados" aria-selected="false">Finalizados</a>
    </li>
</ul>
    </ul>
