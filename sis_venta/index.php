...
if (!empty($_SESSION['active'])) {
  ...
  Ingrese su usuario y su clave
      ...
      $query = mysqli_query($conexion, "SELECT u.idusuario, u.nombre, u.correo, u.usuario, r.idrol, r.rol FROM usuario u INNER JOIN rol r ON u.rol = r.idrol WHERE u.usuario = '$user' AND u.clave = '$clave' AND u.rol <> 2");
          ...
          <div class="card-body p-0">
            ...
            <div class="row">
              <div class="col-lg-6 d-none d-lg-block bg-login-image">
                <img src="sistema/img/fon.jpg" class="img-thumbnail">
              </div>
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h6 text-gray-900 mb-4">BIENVENIDO AL SISTEMA DE CONTROL DE VENTAS, ADMINISTRACIÓN
DE RECURSOS Y ALMACENAMIENTO DE PRODUCTOS</h1>
                  </div>
