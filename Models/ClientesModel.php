...
class ClientesModel extends Query{
    ...
    public function registroDirecto($nombre,$telefono ,$correo ,$clave, $token)
    {
        $sql = "INSERT INTO clientes (nombre, telefono ,correo, clave, token) VALUES (?,?,?,?,?)";
        $datos = array($nombre,$telefono ,$correo, $clave, $token);
